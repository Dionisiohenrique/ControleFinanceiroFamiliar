...
- Crie um projeto angular com ng: `ng new "ControleFinanceiroFamiliar.WebApp" --defaults --skip-install --skip-git --no-standalone `.
- Atualize angular.json com a porta.
- Criar o arquivo de projeto (`ControleFinanceiroFamiliar.WebApp.esproj`).
